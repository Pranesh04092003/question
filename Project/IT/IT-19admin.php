    ...
    <main>
        <section class="department" id="cse">
            ...
            <section class="book-list">
                <h3><a href="/Project/Sem-19Admin/semester1admin.php"  class="semester-link">Semester 1</a></h3>
                <h3><a href="/Project/Sem-19Admin/semester2admin.php"  class="semester-link">Semester 2</a></h3>
                <h3><a href="/Project/Sem-19Admin/semester3admin.php"  class="semester-link">Semester 3</a></h3>
                <h3><a href="/Project/Sem-19Admin/semester4admin.php"  class="semester-link">Semester 4</a></h3>
                <h3><a href="/Project/Sem-19Admin/semester5admin.php"  class="semester-link">Semester 5</a></h3>
                <h3><a href="/Project/Sem-19Admin/semester6admin.php"  class="semester-link">Semester 6</a></h3>
                <h3><a href="/Project/Sem-19Admin/semester7admin.php"  class="semester-link">Semester 7</a></h3>
