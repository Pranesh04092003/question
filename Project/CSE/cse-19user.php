    ...
    <main>
        <section class="department" id="cse">
            ...
            <section class="book-list">
                <h3><a href="\Project\CSE\CSE-2019\User\semester1user.php"  class="semester-link">Semester 1</a></h3>
                <h3><a href="\Project\CSE\CSE-2019\User\semester2user.php"  class="semester-link">Semester 2</a></h3>
                <h3><a href="\Project\CSE\CSE-2019\User\semester3user.php"  class="semester-link">Semester 3</a></h3>
                <h3><a href="\Project\CSE\CSE-2019\User\semester4user.php"  class="semester-link">Semester 4</a></h3>
                <h3><a href="\Project\CSE\CSE-2019\User\semester5user.php"  class="semester-link">Semester 5</a></h3>
                <h3><a href="\Project\CSE\CSE-2019\User\semester6user.php"  class="semester-link">Semester 6</a></h3>
                <h3><a href="\Project\CSE\CSE-2019\User\semester7user.php"  class="semester-link">Semester 7</a></h3>
