      ...
      <h2>Select Your Regulation</h2>
        <section class="department" id="cse">
            ...
            <section class="book-list">
                <h3><a href="\Project\CSE\cse-19admin.php" class="semester-link">Regulation-2019</a></h3><br>
                <h3><a href="\Project\CSE\cse-23admin.php" class="semester-link">Regulation-2023</a></h3><br>
